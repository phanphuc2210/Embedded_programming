...
//Có san mot handle cua Timer4 là htim4
...
//Ham dieu khien huong cua motor
void directionControl(){
	//toc do toi da
...
//Ham dieu khien toc do cua motor
void speedControl(){
	//bat motor 1 va 2
	//motor 1
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_10,GPIO_PIN_SET);
